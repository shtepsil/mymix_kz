...
use backend\modules\catalog\models\ItemRecommend;
...
class ItemRecommendController extends AdminController
{
    public function init()
    {
        $this->on(self::EVENT_BEFORE_ACTION, function () {
            $this->model = new ItemRecommend();
        });
