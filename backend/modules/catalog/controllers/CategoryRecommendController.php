...
use backend\modules\catalog\models\CategoryRecommend;
...
class CategoryRecommendController extends AdminController
{
    public function init()
    {
        $this->on(self::EVENT_BEFORE_ACTION, function () {
            $this->model = new CategoryRecommend();
        });
        ...
        $this->view->title = 'CategoryRecommend';
