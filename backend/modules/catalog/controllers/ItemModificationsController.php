...
use backend\modules\catalog\models\ItemModifications;
...
class ItemModificationsController extends AdminController
{
    public function init()
    {
        $this->on(self::EVENT_BEFORE_ACTION, function () {
            $this->model = new ItemModifications();
        });
        ...
        $this->view->title = 'ItemModifications';
