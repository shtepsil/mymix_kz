 ...
 * @var $items backend\modules\catalog\models\Options[]
 */
...
<section id="content">
    <div class="panel">
        <div class="panel-heading">
			...
			<a href="<?= Url::to([$url . '/change-type']) ?>" class="btn-primary btn">
				<i class="fa fa-exchange"></i> <span class="hidden-xs hidden-sm">Изменение типа</span></a>
        </div>
